...
def check_return_eligibility(category, reason):
    """Check whether a return reason is allowed for a category."""
        ...
        if policy["category"].lower() == category:
            ...
            if reason in allowed_reasons:
                return {
                    ...
                    "next_step": (
                        f"Return within "
                        f"{policy['return_window_days']} days. "
                        f"{policy['refund_rule']} "
                        f"Refund method: "
            ...
            return {
                "eligible": False,
                "message": (
                    "This reason is not covered by "
                    "the return policy."
                ),
                "next_step": (
                    "Contact Northstar Support for assistance."
                )
            }
    ...
    return {
        "eligible": False,
        "message": (
            "We could not find a return policy "
            "for this category."
        ),
        "next_step": (
            "Contact Northstar Support for assistance."
